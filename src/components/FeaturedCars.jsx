...
const FeaturedCars = () => {
  return (
    <section className='bg-gray-100 py-20 sm:py-16 px-4'>
         <div className='max-w-7xl mx-auto text-center mb-12'>
            <h2 className="sm:text-4xl text-3xl font-bold mb-2 flex justify-center items-center gap-2 hover:transform hover:scale-105 transition duration-300">
        ...
        <button className='mx-auto flex items-center justify-center mt-12 bg-blue-500 py-2 px-5 text-white rounded cursor-pointer gap-1 transition duration-300 hover:bg-blue-700 hover:-translate-y-1'>View All Cars <ArrowRight className='w-5 h-5' /></button>
    </section>
  )
}
